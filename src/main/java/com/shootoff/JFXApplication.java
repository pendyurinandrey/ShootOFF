...
public class JFXApplication extends Application {
	...
	private void startGui(Configuration config) {
		try {
			final FXMLLoader loader = new FXMLLoader(JFXApplication.class.getResource("/com/shootoff/gui/ShootOFF.fxml"));
			loader.load();
	...
	public static void main(String[] args) {
		...
		try (InputStream inputStream = JFXApplication.class.getResourceAsStream("/version.properties")) {
